...
class Expressions {
    constructor(_model, typeService, parameterService, expressionNormalize, expressionParse, operandNormalizer, operandReducer, cache) {
        ...
        this.observers = [];
        this.operandService = new operand_1.OperandService(typeService, cache);
        const basic = new operand_1.BasicOperandBuilder(expressionNormalize, expressionParse, operandNormalizer, operandReducer, _model);
        const process = new operand_1.ProcessOperandBuilder(expressionNormalize, expressionParse, operandNormalizer, operandReducer, _model);
        new library_1.CoreLibrary(_model, basic).load();
