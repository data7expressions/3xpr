...
export class OperandBuilder implements IOperandBuilder {
	...
	public constructor (protected readonly model: IModelService, protected readonly normalizer:IOperandNormalizer, protected readonly reducer:IOperandReducer, protected readonly factory: IEvaluatorFactory) {}
