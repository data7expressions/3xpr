...
describe('string', () => {
	...
	test('lab', () => {
		...
		expect(exp.eval('$HOME', context)).toStrictEqual('/home/flavio')
		expect(exp.eval('${USER}', context)).toStrictEqual('flavio')
		expect(exp.eval('concat($HOME,$USER)', context)).toStrictEqual('/home/flavioflavio')
		expect(exp.eval('concat(${HOME},$USER)', context)).toStrictEqual('/home/flavioflavio')
		expect(exp.eval('"Hello"+" "+"world"', context)).toStrictEqual('Hello world')
		expect(exp.eval('`value of home: $HOME`', context)).toStrictEqual('value of home: /home/flavio')
