...
describe('Access', () => {
	test('labs', () => {			
		...
		expect(['Pear','Banana','White grape']).toStrictEqual(expressions.eval('orders.0.details.article',context))
		expect('White grape').toBe(expressions.eval('orders[0].details.2.article',context))
		expect([{"article":"Pear","unitPrice":1.78,"qty":2},{"article":"Banana","unitPrice":1.99,"qty":1},{"article":"White grape","unitPrice":2.03,"qty":1}]).toStrictEqual(expressions.eval('orders.0.details',context))
