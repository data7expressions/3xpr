...
describe('comparison', () => {
	...
	test('lab', () => {
		...
		expect(exp.eval('in(devices,"other")', context)).toStrictEqual(false)
		expect(exp.eval('devices.in("phone")', context)).toStrictEqual(true)
		expect(exp.eval('devices.in(device)', context)).toStrictEqual(true)
		expect(exp.eval('["garage", "house","office"].in(d)', context)).toStrictEqual(true)
