...
describe('Numeric', () => {
	...
	test('labs', () => {	
		...
		expect(1.9459101490553132).toStrictEqual(expressions.eval('ln(7)',context))
		expect(1.9459101490553132).toStrictEqual(expressions.eval('log(7,10)',context))
		expect(0.8450980400142568).toBe(expressions.eval('log10(7)',context))
		expect(1).toStrictEqual(expressions.eval('remainder(7,2)',context))
		expect(7.98).toStrictEqual(expressions.eval('round(7.984938,2)',context))
